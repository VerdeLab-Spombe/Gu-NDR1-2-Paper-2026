...
data1 = readtable('1_layer_Example_1_modified.csv');
data = data1(:, 1:91);
%data = data1 69:133;
...
saveas(fig1, 'Adjusted_1_layer_Example_1_New.fig');
...
saveas(fig2, 'Adjusted_Blurred_1_layer_Example_1_New.fig');
%saveas(fig2, 'Blurred_4_layer_20_scr-1102-Cdc42-1-1.tif', 'tiff');
